...
//    private TextView mTvBack;
    ...
    private int centerX;
    private int centerY;
    private int depthZ = 700;//Z轴移动的距离，这个来影响视觉效果，可以解决flip animation那个给人看似放大的效果
...
//                container.setBackgroundResource(R.drawable.bg_shape_update_version_dialog);
...
//                container.setBackgroundResource(R.drawable.bg_2);
